...
`v0.4.0` is the current GitHub Action release line. Use `kingkyylian/shipproof@v0.4.0` for published-action installs; use `uses: ./` only when dogfooding local checkout changes inside this repository.
